...
class RandomizedIncrementalConstruction:
    ...
    def insertLinesegment(self, line_seg):
        ...
        intersectingTrapezoids, (pNode, pExisted), (qNode, qExisted) = self.getIntersectingTrapezoids(line_seg)
        ...
        if len(intersectingTrapezoids) == 1:
            ...
            newLeftBottomTrapezoid = Trapezoid(line_seg.p, pTrapezoid.right_p,
                                               line_seg, pTrapezoid.bottom)
            ...
            newLeftTopTrapezoid = Trapezoid(line_seg.p, pTrapezoid.right_p,
                                            pTrapezoid.top, line_seg)
            newLeftTopTrapezoid.setRightNeighbors(
                {n for n in pTrapezoid.right_neighbors if line_seg.aboveLine(n.bottom.q)})

            if not pExisted:
                newLeftTrapezoid = Trapezoid(pTrapezoid.left_p, line_seg.p, pTrapezoid.top,
                                             pTrapezoid.bottom)
            ...
            newRightBottomTrapezoid = Trapezoid(qTrapezoid.left_p, line_seg.q,
                                                line_seg, qTrapezoid.bottom)
            ...
            newRightTopTrapezoid = Trapezoid(qTrapezoid.left_p, line_seg.q,
                                             qTrapezoid.top, line_seg)
            newRightTopTrapezoid.setLeftNeighbors(
                {n for n in qTrapezoid.left_neighbors if line_seg.aboveLine(n.bottom.q)})

            if not qExisted:
                newRightTrapezoid = Trapezoid(line_seg.q, qTrapezoid.right_p, qTrapezoid.top,
                                              qTrapezoid.bottom)
            ...
            for t in intersectingTrapezoids[1:-1]:
                ...
                new_top = Trapezoid(t.left_p, t.right_p,
                                    t.top, line_seg)
                new_bottom = Trapezoid(t.left_p, t.right_p,
                                       line_seg, t.bottom)
